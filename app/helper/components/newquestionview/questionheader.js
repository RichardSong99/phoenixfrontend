            ...
            <div className='w-full h-full flex flex-row justify-between'>
                ...
                <div className='h-full w-[250px] flex flex-col items-center justify-center text-center '>
                    ...
                    <div className = "flex flex-row gap-2">
                        ...
                        {engagementStatus !== "unattempted" && (<Chip className = "text-white" color = {engagementStatusChipColor}>{engagementStatus}</Chip>)}</div>
                </div>
                        ...
                        (activeReviewMode === "active" ? (
                            <>
                                <div className='flex-col w-[200px]'>
                                    ...
                                    {activeReviewMode === "active" ? (
                                        <Button className='text-[14px] text-white h-[20px] bg-themeDarkGray text-[12px]' size = "sm" onClick={handleShowTimer}>
