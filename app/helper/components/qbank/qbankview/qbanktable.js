...
const QBankTable = ({ questionEngagementCombos: initialCombos }) => {
  ...
  return (
    <div className="flex flex-col gap-y-4 p-2">
      { user.type === "admin" ? <> <Table removeWrapper>
        <TableHeader>
          ...
          <TableColumn>Review Response</TableColumn>
        ...
        <TableBody>
          {questionEngagementCombos.map((questionEngagement, index) => (
            <TableRow key={index}>
              ...
              <TableCell>
                {questionEngagement?.Engagement?.attempt_time && (
                  <div>
                    {formatDate(questionEngagement?.Engagement?.attempt_time)}
                  </div>
                )}
              </TableCell>
      ...
      <Table removeWrapper>
        <TableHeader>
          ...
          <TableColumn>Date Answered</TableColumn>
          <TableColumn>Reviewed</TableColumn>
          <TableColumn>Review Reason</TableColumn>
          <TableColumn>Amount of time</TableColumn>
          <TableColumn>Flagged</TableColumn>
          <TableColumn>Starred</TableColumn>
        </TableHeader>
