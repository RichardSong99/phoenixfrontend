        ...
        <div className={styles.questionSideNav}>
            ...
            <div className={styles.infoSection}>
                ...
                {mode !== "test" && <div className = {styles.progressDiv}>
                 <ProgressBar now={100*percentCompleted} style={{ height: '7px', width: '100%' }} variant="info" />
...
export const ObjectLink = ({
    ...
    return (
        // JSX code for the component goes here
        <div className={`${styles.questionLink} ${styles[className]}`} onClick={() => handleObjectClick({index: objectIndex})}>
            <span className={styles.questionNumber}>
                {title}
            </span>

            <div className={styles.statusIconDiv}>
                {showDifficulty && <div className={styles.difficulty}>{difficulty}</div>}
