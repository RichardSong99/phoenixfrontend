                    ...
                    <Card>
                        ...
                        <CardBody>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
                                {selectedQuestionTab === "unattempted" && unattemptedQuestions.slice(0, 9).map((question, index) => (
                                    <QuestionCard key = {index} question={question} clickQuestionHandler = {onQuestionClick}/>
                                ))}
                                {selectedQuestionTab === "recentlyAnswered" && recentlyAnsweredQuestions.slice(0, 9).map((question, index) => (
                                    <QuestionCard key = {index} question={question} clickQuestionHandler = {onQuestionClick}/>
                                ))}
                            </div>
                        </CardBody>
